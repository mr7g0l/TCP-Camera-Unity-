...
def parse_args():
    ...
    parser.add_argument("-w",    type=int, default=360,  help="Ancho en píxeles (default: 360)")
    parser.add_argument("-ht",   type=int, default=240,  help="Alto en píxeles (default: 240)")
